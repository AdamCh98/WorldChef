...
@Database(entities = {User.class, Categories.Category.class, MealsPerCategory.MealFromCategory.class, MealDetail.Meal.class, Favourite.class}, version = 1)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static AppDatabase getInstance(Context context) {
        ...
        if(instance == null) {
            instance = Room.databaseBuilder(context, AppDatabase.class, "worldChefDbv1000")
